...
export default function ReviewPage() {
  ...
  return (
    <div className="px-4 pt-6 pb-24">
      <h1 className="text-xl font-bold text-brand-800 mb-2">復習モード</h1>
      ...
      {reviewCount > 0 ? (
        <>
          <Link
            ...
            className="block bg-brand-700 text-white font-bold py-4 rounded-2xl text-center active:bg-brand-800 transition-colors mb-6"
          >
        ...
        <div className="bg-white rounded-2xl p-8 text-center border border-brand-100">
          ...
          <Link
            href="/stages"
            className="inline-block bg-brand-700 text-white font-bold py-3 px-8 rounded-xl active:bg-brand-800 transition-colors"
          >
            ステージ一覧へ
          </Link>
        </div>
