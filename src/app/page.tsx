...
export default function HomePage() {
  ...
  return (
    <div className="px-4 pt-0">
      ...
      <div className="bg-gradient-to-r from-brand-800 to-brand-700 -mx-4 px-5 pt-8 pb-6 mb-6 rounded-b-3xl shadow-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white tracking-wide">DSCSS</h1>
              <p className="text-xs text-brand-200">情報セキュリティマネジメント</p>
            </div>
          </div>
        ...
        {passing ? (
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-slate-500">
              合格圏まであと <span className="font-bold text-brand-600">{Math.max(0, 800 - totalScore)}点</span>
            </p>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        {lastSession ? (
          ...
          >
            ...
            <div className="font-bold text-sm text-brand-800">📋 ステージ選択</div>
      ...
      <h2 className="text-sm font-bold text-brand-800 mb-3">ステージ一覧</h2>
