...
export default function StagesPage() {
  ...
  return (
    <div className="px-4 pt-6">
      <h1 className="text-xl font-bold text-slate-800 mb-2">ステージ一覧</h1>
        ...
        {STAGES.map((stage, index) => {
          ...
          return (
            <Link
              ...
              className="block bg-white rounded-2xl p-5 border border-slate-100 shadow-sm active:shadow-none active:bg-slate-50 transition-all"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h2 className="font-bold text-slate-800 mt-0.5">
                    {stage.name}
                  </h2>
