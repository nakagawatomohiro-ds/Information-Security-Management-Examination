...
export default function ProgressPage() {
  ...
  return (
    <div className="px-4 pt-6 pb-24">
      <h1 className="text-xl font-bold text-brand-800 mb-6">学習進捗</h1>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-brand-100 mb-6">
        ...
        {passing ? (
          <div className="mt-4 text-center bg-brand-50 rounded-xl py-3 px-4">
            <span className="text-brand-700 font-bold">🎉 合格圏到達！</span>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-white rounded-xl p-3 text-center border border-brand-100">
          <div className="text-xl font-bold text-brand-800">{totalSessions}</div>
          <div className="text-xs text-slate-500">セッション数</div>
        </div>
        <div className="bg-white rounded-xl p-3 text-center border border-brand-100">
          <div className="text-xl font-bold text-brand-800">{totalQuestions}</div>
      ...
      {recentSessions.length > 0 && (
        <div className="bg-white rounded-2xl p-5 border border-brand-100 mb-6">
          <h2 className="text-sm font-bold text-brand-700 mb-4">
                ...
                >
                  ...
                  <div
                    className={`w-full rounded-t ${
                      session.score >= 800 ? "bg-brand-400" : "bg-brand-300"
                    }`}
          ...
          <div className="relative -mt-[80%] mb-[60%] ml-0 mr-0">
            <div
              className="border-t border-dashed border-brand-300 absolute w-full"
              style={{ bottom: "80%" }}
            />
          </div>
        </div>
      ...
      {sortedTags.length > 0 && (
        <div className="mb-6">
          ...
          <div className="bg-white rounded-xl border border-brand-100 divide-y divide-slate-50">
      ...
      {totalSessions === 0 && (
        <div className="bg-white rounded-2xl p-8 text-center border border-brand-100">
          ...
          <h2 className="text-lg font-bold text-brand-800 mb-2">
            まだデータがありません
          </h2>
          <p className="text-sm text-slate-500">
            クイズを解くと進捗が表示されます
